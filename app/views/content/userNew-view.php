		  	...
		  	<div class="column">
		    	<div class="control has-icons-right">
					<label>Clave <?php echo CAMPO_OBLIGATORIO; ?></label>
				  	<input id="usuario_clave_1" class="input" type="password" name="usuario_clave_1" pattern="[A-Za-z0-9@$._-]{7,100}" maxlength="100" required >
				  	<span class="icon is-small is-right toggle-password" data-target="usuario_clave_1" style="cursor:pointer;pointer-events:auto" title="Mostrar/Ocultar" role="button" tabindex="0"><i class="fas fa-eye"></i></span>
				</div>
		  	</div>
		  	<div class="column">
		    	<div class="control has-icons-right">
					<label>Repetir clave <?php echo CAMPO_OBLIGATORIO; ?></label>
				  	<input id="usuario_clave_2" class="input" type="password" name="usuario_clave_2" pattern="[A-Za-z0-9@$._-]{7,100}" maxlength="100" required >
				  	<span class="icon is-small is-right toggle-password" data-target="usuario_clave_2" style="cursor:pointer;pointer-events:auto" title="Mostrar/Ocultar" role="button" tabindex="0"><i class="fas fa-eye"></i></span>
				</div>
		  	</div>
		</div>
		<div class="columns">
